...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    {
      name: 'Estados de Empleados',
      href: '/dashboard/admin/employee-states',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Solicitudes Salida Anticipada',
      href: '/dashboard/admin/early-departure',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-gray-800 transition ease-in-out duration-300 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-white text-lg font-semibold">RH System</h1>
            </div>
