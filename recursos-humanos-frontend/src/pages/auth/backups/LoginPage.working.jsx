...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.user) {
        console.error("No hay información de usuario en la respuesta");
        setError("Error en la respuesta del servidor: falta información de usuario");
        return;
      }
      ...
      // Para depuración
      alert(`Autenticado como: ${isAdmin ? 'ADMINISTRADOR' : 'EMPLEADO'}`);
      
      // Redirect based on user role - FORZANDO las URL correctas
      if (isAdmin) {
